...
namespace bangazon
{
    public class HRNightShiftEmployee : Employee, IFullTime, IDeptLocation, INightShift
    {
        ...
        public HRNightShiftEmployee(string firstName, string lastName, string shiftHours, int breakFrequency) : base(firstName, lastName)
        {
